...
\end{equation}
Za pozornost stojí poslední nerovnost, která plyne z toho, že skalární součin dvou pozitivně semidefinitních matic je nezáporný. Odvození je následující: mějme dvě matice $S, T \succeq 0$. Matici $S$ můžeme napsat jako součet \uv{rank one} matic. Označme $r_S = rank(S)$, tj.
$$
...
\begin{vt}[silná dualita semidefinitního programování]
