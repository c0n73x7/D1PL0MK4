...
\noindent Říkáme, že $K$ je \textbf{bodový kužel}, jestliže neobsahuje žádnou přímku, tj.
$$
...
\begin{lm2}
    Kužel $S_+^n$ je samoduální, tj. $S_+^n = (S_+^n)^*$.
\end{lm2}
...
\noindent Množinu $S_+^n$ nazýváme \textbf{pozitivně semidefinitní kužel}.
